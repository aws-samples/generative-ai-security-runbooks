...
- In [Module 1](./notebooks/Module1.ipynb) - you will use Claude Sonnet from Anthropic to summarize a security findings, provide next steps for remediation, and create code to resolve the finding.
- In [Module 2](./notebooks/Module2.ipynb) - you will learn tool use (also referred to as function calling), an advanced technique to expand Claude Sonnet capabilities to get real time data.
